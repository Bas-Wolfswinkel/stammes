<div class="hero-section relative min-h-[714px] bg-cover bg-bottom pt-[210px] md:min-h-[832px] md:pb-[20vh] md:pt-[30vh]"
    ...
    @endif>
    <div class="absolute left-0 top-0 h-[317px] w-full"
        style="background: linear-gradient(180deg, #13565E 0%, rgba(19, 86, 94, 0.00) 89.78%); background-blend-mode: multiply;">
    </div>
    <x-container>
